const cars = [
  {
    ...
    fuel: "Gasoline",
    description:
      "Experience the pinnacle of Porsche engineering with the 911 Turbo S. This masterpiece combines breathtaking performance with everyday usability.",
    images: [
...

  {
    ...
    fuel: "Gasoline",
    description:
      "A luxury sedan built for comfort, class, and smooth driving.",
    images: [
...

  {
    ...
    fuel: "Gasoline",
    description:
      "A powerful sports sedan with luxury interior and strong road presence.",
    images: [
      "https://images.unsplash.com/photo-1617814076367-b759c7d7e738?auto=format&fit=crop&w=1200&q=80",
...

  {
    ...
    fuel: "Gasoline",
    description:
      "A full-size luxury SUV with bold design, comfort, and strong road presence.",
    images: [
...

  {
    ...
    fuel: "Gasoline",
    description:
      "Elegant executive sedan with premium comfort and modern technology.",
    images: [
      "https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1556189250-72ba954cfc2b?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1617814076367-b759c7d7e738?auto=format&fit=crop&w=1200&q=80"
...

  {
    ...
    fuel: "Gasoline",
    description:
      "Luxury SUV with refined interior, smooth drive, and premium off-road capability.",
    images: [
      "https://images.unsplash.com/photo-1606016159991-dfe4f2746ad5?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1609521263047-f8f205293f24?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=1200&q=80"
...
if (carsGrid) {
  ...
  function displayCars(list) {
    ...
    carCount.textContent = `
      ${list.length} premium vehicles available
    `;
...
if (carDetails) {
  ...
  if (!car) {
      ...
      <div class="details-card">
        ...
        <div class="details-actions">
          ...
          <a
            class="whatsapp-big"
            target="_blank"
            href="https://wa.me/96170123456?text=Hello I am interested in the ${encodeURIComponent(car.title)}"
          >
            Contact on WhatsApp
          </a>
    ...
    detailsCard.style.transform = "translateY(30px)";

    setTimeout(() => {

      detailsCard.style.transition = "0.6s ease";
